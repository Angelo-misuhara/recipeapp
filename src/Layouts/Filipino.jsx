...
const Filipino = () => {
  ...
  return (
    < >
      ...
      <div className=" mt-9 flex flex-col justify-center overflow-hidden w-[20rem]">
          <div className= 'w-[20rem] overflow-hidden border grid grid-rows-4 grid-flow-col gap-4' id='filipinoapi'>
          {data.map((item,key) => (
