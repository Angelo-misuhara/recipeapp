        ...
        <span className="intro-logo self-center text-2xl font-bold whitespace-nowrap dark:text-white">Cooking <span className="text-[#f0ec0f]">Inaaa</span></span>
          ...
          <div>
            <ul className="flex flex-row flex-wrap gap-7">
              {ul.map((item, key) => (
                <li key={key} className=" font-semibold hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-[#c5c22a] md:p-0 dark:text-white md:dark:hover:text-[#c5c22a] dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                  <a href="">
                    {item}
                  </a>
                </li>
